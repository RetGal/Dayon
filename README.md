...
The ![latest version](https://github.com/RetGal/Dayon/releases/latest) is 1.5.1 - released more than eight years after the latest release of the original author.
