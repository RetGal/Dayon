...
CLASSPATH="$DAYON_HOME/lib/dayon.jar:$DAYON_HOME/lib/annotations-7.0.2.jar:$DAYON_HOME/lib/jetty-continuation-8.1.21.v20160908.jar:$DAYON_HOME/lib/jetty-http-8.1.21.v20160908.jar:$DAYON_HOME/lib/jetty-io-8.1.21.v20160908.jar:$DAYON_HOME/lib/jetty-server-8.1.21.v20160908.jar:$DAYON_HOME/lib/jetty-util-8.1.21.v20160908.jar:$DAYON_HOME/lib/servlet-api-3.0.jar"
