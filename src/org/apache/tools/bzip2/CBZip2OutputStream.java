...
public class CBZip2OutputStream extends OutputStream implements BZip2Constants {
	...
	/*
	 * Performs Move-To-Front on the Burrows-Wheeler transformed buffer, storing
	 * the MTFed data in data.sfmap in RUNA/RUNB run-length-encoded form.
	 *
	...
	static final class Data extends Object {
		...
		/*
		 * holds the RLEd block of original data starting at index 1. After
		 * sorting the last byte added to the buffer is at index 0.
		 */
		final byte[] block; // 900021 byte
		/*
		 * maps index in Burrows-Wheeler transformed block => index of byte in
		 * original block
		 */
