...
public class CBZip2InputStream extends InputStream implements BZip2Constants {
	 ...
	 *            after the first .bz2 stream and leave the input position to
	 ...
	 *             if <tt>in == null</tt>
	 */
	private CBZip2InputStream(final InputStream in, final boolean decompressConcatenated) throws IOException {
		super();
