...
public abstract class DialogFactory
{
    ...
    {
        /**
         * @return {@code null} if the validation is fine; otherwise an error message.
         */
        @Nullable
        String validate();
    }
     ...
     */
    public static boolean showOkCancel(final Component owner,
                                       final String title,
                                       final JComponent payloadPane,
     ...
     */
    private static JDialog createDialog(Component owner, String title, JComponent payloadPane, JButton[] buttons, JButton defaultButton, boolean hasEscapeButton)
    {
        final Frame parent
    ...
    public static boolean showYesNo(Component owner, String title, String message)
    {
        final Object[] options = {
                Babylon.translate("yes"),
                Babylon.translate("no"),
        };
