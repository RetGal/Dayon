...
public class CaptureEngine implements ReConfigurable<CaptureEngineConfiguration>
{
    ...
    public void addListener(CaptureEngineListener listener)
    {
        ...
        // We're keeping locally a previous state so we must be sure to send at least
    ...
    private void mainLoop() throws InterruptedException
    {
        ...
        while (true)
        {
            ...
            if (dirty != null)
            {
                final Capture capture = new Capture(captureId, reset, skipped, 0, captureFactory.getWidth(), captureFactory.getHeight(), TILE_WIDTH, TILE_HEIGHT, dirty);
